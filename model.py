...
class CareGiverClassification(pl.LightningModule):

    def __init__(self):
        super(CareGiverClassification, self).__init__()
...
class CareGiverDataset(Dataset):
...
class CareGiverDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        if stage in (None, 'fit'):
            full = CareGiverDataset(self.full_data_path, self.max_seq_len)
            ...
            self.test = CareGiverDataset(self.test_data_path, self.max_seq_len)
